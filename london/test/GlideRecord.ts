...
(function getED() {
    // NOTE: Scoped API docs has invalid example
    var gr = new GlideRecord('incident');
...
(function() {
    ...
    // /incident.do?sys_id=9d385017c611228701d22104cc95c371&sysparm_stack=incident_list.do
