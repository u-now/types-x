...
declare class RESTMessageV2 {
   ...
   * When using an object instantiated this way, you must manually specify an HTTP method
   * and endpoint.
   */
  constructor();
   ...
   * any roles required to read and write records on the table specified in the tableName parameter.
   ...
   * results in the ECC queue with the request when designing asynchronous automation through
   * a MID Server.
   ...
   * In the following example, replace REST_message_record with the name of the REST message
   * record from your instance.
   * @param timeoutMs The amount of time, in milliseconds, before the call to the REST
   * provider times out.
   * @returns Method does not return a value
   *
   * @example
   ...
   * @param stream The binary data to send, such as an attachment or a stream from a
   * 3rd-party service.
   * @returns Method does not return a value
   */
