declare namespace sn_ws {
     ...
     *
     * Note: You cannot instantiate objects of this type. Objects of this type are created automatically
     * and are accessible only in scripted REST API resource scripts.
     */
